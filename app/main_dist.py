...
from models.model import Conductor
...
df_conductor = pd.read_sql(session.query(Conductor).statement, con=conn)
...
# imprimir uñtima fecha y último indice 
